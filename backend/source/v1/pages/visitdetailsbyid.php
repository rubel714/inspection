...
try{
	...
	ifnull(a.DropDownListIDForTransportation,'') AS DropDownListIDForTransportation,ifnull(d.DisplayName,'') AS Transportation,
	...
	$query7 = "SELECT a.MachinePartsId, b.MachinePartsName
	...
	foreach($resultdata7 as $key=>$row){
		$SelfFBVisitMachineParts[]=array("MachinePartsName"=>$row["MachinePartsName"]);
	}
