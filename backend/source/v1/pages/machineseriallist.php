...
try{
	...
	$MachineModelId =  isset($data['MachineModelId']) ? $data['MachineModelId'] : '';
	
	if ($MachineId == "" || $MachineModelId == "") {
		$apiResponse = json_encode(recordNotFoundMsg(0, "MachineId or MachineModelId param is missing"));
	...
	a.MachineSerialId, a.MachineSerial
	FROM t_machineserial a
	where a.MachineId=$MachineId
	and a.MachineModelId=$MachineModelId
	ORDER BY a.MachineSerial ASC;";		
