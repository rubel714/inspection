...
$spreadsheet = new Spreadsheet();
    ...
    $reporttitlelist[] = "Visit Summary Report";
...
$spreadsheet->getActiveSheet()
        ...
        ->SetCellValue('D'.$rn, "Customer Name")
        ->SetCellValue('E'.$rn, "Contact Name")
        ->SetCellValue('F'.$rn, "Designation")
        ->SetCellValue('G'.$rn, "Self Discussion")
        ->SetCellValue('H'.$rn, "HOT Advice")
		;
...
foreach ($result as $row) {
    ...
    $spreadsheet->getActiveSheet()
            ...
            ->SetCellValue('E' . $j, $row["ContactPersonName"])
            ->SetCellValue('F' . $j, $row["ContactPersonDesignation"])
            ->SetCellValue('G' . $j, $row["SelfDiscussion"])
            ->SetCellValue('H' . $j, $row["HOTAdvice"])
			;
...
$file = 'VisitSummaryReport-' . $exportTime . '.xlsx'; //Save file name
