...
import DefectDescriptionReport from "./DefectDescriptionReport";

const Index = (props) => {
  const { path } = useRouteMatch();
  const menukey = "defectdescriptionreport"; // this is in t_menu table
      ...
      <div >
        ...
        <Switch>
          <Route
            path={`${path}/`}
            render={(props) => (
              <DefectDescriptionReport {...props} openNoticeModal={openNoticeModal} />
            )}
          ></Route>
        </Switch>
        <Notification
