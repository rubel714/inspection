...
import InspectionReportImport from "./InspectionReportImport.js";

const Index = (props) => {
  const { path } = useRouteMatch();
  const menukey = "inspectionreportimport"; // this is in t_menu table
      ...
      <div class="pb-30">
        ...
        <Switch>
          <Route
            path={`${path}/`}
            render={(props) => (
              <InspectionReportImport {...props} openNoticeModal={openNoticeModal} 
