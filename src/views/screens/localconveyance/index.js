...
import LocalConveyance from "./LocalConveyance.js";

const Index = (props) => {
  const { path } = useRouteMatch();
  const menukey = "localconveyance"; // this is in t_menu table
      ...
      <div class="pb-30">
        ...
        <Switch>
          <Route
            path={`${path}/`}
            render={(props) => (
              <LocalConveyance {...props} openNoticeModal={openNoticeModal} 
