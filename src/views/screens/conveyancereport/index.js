...
import ConveyanceReport from "./ConveyanceReport.js";

const Index = (props) => {
  const { path } = useRouteMatch();
  const menukey = "conveyancereport"; // this is in t_menu table
      ...
      <div class="pb-30">
        ...
        <Switch>
          <Route
            path={`${path}/`}
            render={(props) => (
              <ConveyanceReport {...props} openNoticeModal={openNoticeModal} 
