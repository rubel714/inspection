...
import CheckListAddEditModal from "./CheckListAddEditModal";
...
const CheckList = (props) => {
  ...
  return (
    <>
      ...
      {showModal && (<CheckListAddEditModal masterProps={props} currentRow={currentRow} modalCallback={modalCallback} />)}
