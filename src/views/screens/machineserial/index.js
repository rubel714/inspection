...
import Machineserial from "./Machineserial.js";

const Index = (props) => {
  const { path } = useRouteMatch();
  const menukey = "machineserial"; // this is in t_menu table
      ...
      <div class="pb-30">
        ...
        <Switch>
          <Route
            path={`${path}/`}
            render={(props) => (
              <Machineserial {...props} openNoticeModal={openNoticeModal}  permissionType={permissionType}/>
            )}
          ></Route>
        </Switch>
        <Notification
