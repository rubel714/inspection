...
import MachineryServiceReport from "./MachineryServiceReport.js";

const Index = (props) => {
  const { path } = useRouteMatch();
  const menukey = "machineryservicereport"; // this is in t_menu table
      ...
      <div class="pb-30">
        ...
        <Switch>
          <Route
            path={`${path}/`}
            render={(props) => (
              <MachineryServiceReport {...props} openNoticeModal={openNoticeModal} 
