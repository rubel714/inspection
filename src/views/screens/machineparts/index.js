...
import Machineparts from "./Machineparts.js";

const Index = (props) => {
  const { path } = useRouteMatch();
  const menukey = "machineparts"; // this is in t_menu table
      ...
      <div class="pb-30">
        ...
        <Switch>
          <Route
            path={`${path}/`}
            render={(props) => (
              <Machineparts {...props} openNoticeModal={openNoticeModal}  permissionType={permissionType}/>
            )}
          ></Route>
        </Switch>
        <Notification
