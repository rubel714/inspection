...
const MachinepartsAddEditModal = (props) => { 
  ...
  const validateForm = () => {
    ...
    let validateFields = ["MachineId","MachinePartsName"]
    let errorData = {}
    let isValid = true
    ...
    <>
      ...
      <div id="groupModal" class="modal">
        ...
        <div class="modal-content">
          ...
          <div class="modalItem">
            <label>Machine Parts Name *</label>
            <input
              type="text"
              id="MachinePartsName"
              name="MachinePartsName"
              class={errorObject.MachinePartsName}
              placeholder="Enter machine parts name"
              value={currentRow.MachinePartsName}
              onChange={(e) => handleChange(e)}
            />
          </div>
...
export default MachinepartsAddEditModal;
