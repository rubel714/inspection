...
import VisitSummaryReport from "./VisitSummaryReport.js";

const Index = (props) => {
  const { path } = useRouteMatch();
  const menukey = "visitsummaryreport"; // this is in t_menu table
      ...
      <div class="pb-30">
        ...
        <Switch>
          <Route
            path={`${path}/`}
            render={(props) => (
              <VisitSummaryReport {...props} openNoticeModal={openNoticeModal} 
