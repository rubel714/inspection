...
import InspectionReportEntry from "./InspectionReportEntry";

const Index = (props) => {
  const { path } = useRouteMatch();
  const menukey = "inspectionreportentry"; // this is in t_menu table
      ...
      <div >
        ...
        <Switch>
          <Route
            path={`${path}/`}
            render={(props) => (
              <InspectionReportEntry {...props} openNoticeModal={openNoticeModal} />
            )}
          ></Route>
        </Switch>
        <Notification
