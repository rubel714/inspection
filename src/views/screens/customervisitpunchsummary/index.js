...
import CustomerVisitPunchSummary from "./CustomerVisitPunchSummary.js";

const Index = (props) => {
  const { path } = useRouteMatch();
  const menukey = "customervisitpunchsummary"; // this is in t_menu table
      ...
      <div class="pb-30">
        ...
        <Switch>
          <Route
            path={`${path}/`}
            render={(props) => (
              <CustomerVisitPunchSummary {...props} openNoticeModal={openNoticeModal} 
