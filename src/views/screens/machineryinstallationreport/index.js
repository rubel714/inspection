...
import MachineryInstallationReport from "./MachineryInstallationReport.js";

const Index = (props) => {
  const { path } = useRouteMatch();
  const menukey = "machineryinstallationreport"; // this is in t_menu table
      ...
      <div class="pb-30">
        ...
        <Switch>
          <Route
            path={`${path}/`}
            render={(props) => (
              <MachineryInstallationReport {...props} openNoticeModal={openNoticeModal} 
