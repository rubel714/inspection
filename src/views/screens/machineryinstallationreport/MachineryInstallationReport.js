...
const MachineryInstallationReport = (props) => {
  ...
  const ExcelGenerate = () => {
    ...
    let finalUrl =
      EXCEL_EXPORT_URL + "report/MachineryInstallationReport_excel.php";
    window.open(
      finalUrl +
      "?TransactionId=" +
      currTransactionId +
  ...
  const PDFGenerate = () => {
    ...
    let finalUrl = EXCEL_EXPORT_URL + "report/MachineryInstallationReport_pdf.php";
    window.open(
      finalUrl +
      "?TransactionId=" +
      currTransactionId +
  ...
  function getTransactionList(deptId, visitorId, sDate, eDate) {
    let params = {
      action: "InstallationTransactionList",
      lan: language(),
      UserId: UserInfo.UserId,
      ClientId: UserInfo.ClientId,
      BranchId: UserInfo.BranchId,
  ...
  return (
    <>
      <div class="bodyContainer">
        ...
        <div class="topHeader">
          <h4>
            <a href="#">Home</a> ❯ Reports ❯ Machinery Installation Report
          </h4>
        </div>
...
export default MachineryInstallationReport;
