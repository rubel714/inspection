...
import CustomerVisitPunchLedger from "./CustomerVisitPunchLedger.js";

const Index = (props) => {
  const { path } = useRouteMatch();
  const menukey = "customervisitpunchledger"; // this is in t_menu table
      ...
      <div class="pb-30">
        ...
        <Switch>
          <Route
            path={`${path}/`}
            render={(props) => (
              <CustomerVisitPunchLedger {...props} openNoticeModal={openNoticeModal} 
